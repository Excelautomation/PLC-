 ...
 */
public abstract class CompilerNodeException extends RuntimeCompilerException {
    private Node node;

    public CompilerNodeException(String message, Node node) {
        super(message);
        this.node = node;
    }
    ...
    private void printCode(String code, int startLine, int endLine, int startPos, int endPos) {
        // Get lines
